...
exports.default = triggerWorkflowRunHandler;
const permissions_1 = require("./lib/permissions");
const step_executors_1 = require("./lib/step-executors");
...
`;
async function triggerWorkflowRunHandler(req, res) {
    try {
        ...
        const permCheck = (0, permissions_1.checkWorkflowPermission)({ userId: userId || 'system', orgId, role }, 'run');
        ...
        let data;
        try {
            data = await (0, hasura_1.adminGraphQLRequest)(GET_WORKFLOW_QUERY, { id: workflowId });
        }
        catch {
        ...
        const quotaCheck = (0, permissions_1.checkQuota)(quota_used, quota_allowed);
        ...
        const createRunResult = await (0, hasura_1.adminGraphQLRequest)(CREATE_RUN_MUTATION, {
        ...
        (async () => {
            ...
            for (let i = 0; i < workflow.steps.length; i++) {
                ...
                await (0, hasura_1.adminGraphQLRequest)(UPDATE_STEP_RUN_MUTATION, {
                    id: stepRunRecord.id,
                    status: 'running',
                    input: previousOutput,
                    started_at: startTime,
                });
                const stepRes = await (0, step_executors_1.executeStep)({
                    stepType: step.type,
                    config: step.config,
                    input,
                    previousOutput,
            ...
            await (0, hasura_1.adminGraphQLRequest)(UPDATE_RUN_STATUS_MUTATION, {
                id: runId,
                status: finalStatus,
                completed_at: finalStatus === 'completed' ? new Date().toISOString() : null,
            });
            if (finalStatus === 'completed') {
                await (0, hasura_1.adminGraphQLRequest)(INCREMENT_ORG_QUOTA, { org_id: workflow.org_id });
            }
